...
export default function FoodDetails({ params }: { params: { id: string } }) {
      ...
      <Card className="overflow-hidden">
        ...
        <div className="p-6 space-y-4">
          <div className="flex justify-between items-start">
            ...
            <div className="text-xl font-semibold text-orange-500">${food.price.toFixed(2)}</div>
          </div>
          ...
          <div className="pt-4">
            ...
            <Button className="w-full mt-6 bg-orange-500 hover:bg-orange-600" onClick={handleAddToCart}>
