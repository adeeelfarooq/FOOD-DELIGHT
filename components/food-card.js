    ...
    >
      ...
      <CardContent className="p-4">
        <div className="flex justify-between items-start">
          ...
          <div className="text-orange-red-500 font-semibold">${food.price.toFixed(2)}</div>
        </div>
      </CardContent>
      <CardFooter className="p-4 pt-0">
        <Button className="w-full bg-orange-red-500 hover:bg-orange-red-600" size="sm" onClick={handleAddToCart}>
